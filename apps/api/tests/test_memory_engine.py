...
@pytest.mark.asyncio
async def test_memory_engine_indexing_and_retrieval() -> None:
    ...
    mock_point.payload = {
        ...
        "resolution": "Install python-dotenv package",
        "patch": "+ python-dotenv==1.0.1",
        "outcome": "succeeded",
    }
    ...
    assert results[0]["resolution"] == "Install python-dotenv package"
    assert results[0]["patch"] == "+ python-dotenv==1.0.1"
